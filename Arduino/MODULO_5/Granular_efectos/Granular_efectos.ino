...
AudioPlaySdWav           playSdWav1;     //xy=216,149
AudioMixer4              mixer1;         //xy=385,181
AudioEffectGranular      granular1;      //xy=557,169
AudioMixer4              mixer2;         //xy=651,260
AudioOutputAnalog        dac;            //xy=789,203
AudioConnection          patchCord1(playSdWav1, 0, mixer1, 0);
AudioConnection          patchCord2(playSdWav1, 1, mixer1, 1);
AudioConnection          patchCord3(mixer1, granular1);
AudioConnection          patchCord4(mixer1, 0, mixer2, 1);
AudioConnection          patchCord5(granular1, 0, mixer2, 0);
AudioConnection          patchCord6(mixer2, dac);
...
#define NUM_FILES  6
const char *filenames[NUM_FILES]={"SDTEST0.WAV", "SDTEST1.WAV", "SDTEST2.WAV", "SDTEST3.WAV", "SDTEST4.WAV", "SDTEST5.WAV"};
int nextfile=0;
...
void loop() {
  ...
  float knobA2 = (float)analogRead(A7) / 1023.0;
  float knobA3 = (float)analogRead(A8) / 1023.0;
